    ...
    intercept(context, next) {
        ...
        if (request.params && request.params.id) {
            ...
            if (!uuidRegex.test(id) && !cuidRegex.test(id)) {
                throw new common_1.BadRequestException(`ID inválido: ${id}. Esperado formato UUID ou CUID válido (ex: 123e4567-e89b-12d3-a456-426614174000 ou cmgtzxtsd0001goxmzmitp7s4)`);
            }
        }
        return next.handle();
    }
